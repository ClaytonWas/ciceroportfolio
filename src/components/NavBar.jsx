    ...
    <nav className="relative py-4 text-xl font-bold mb-10 md:mb-0 md:font-normal md:px-32 md:text-2xl xl:text-3xl">
        <div className="flex justify-center md:justify-between">
            <div className="md:space-x-20 md:flex md:items-center">
                <Link to="/" className="flex justify-center hover:text-sky-800">
                ...
                <Link to="/projects" className="px-5 py-3 hover:text-sky-800">Projects</Link>
                <Link to="/blog" className="px-5 py-3 hover:text-sky-800">Blog</Link>
                <Link to="/contact" className="px-5 py-3 hover:text-sky-800">Contact</Link>
            </div>
        </div>
    </nav>
);
